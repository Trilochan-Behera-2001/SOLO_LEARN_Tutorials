<%@page import="com.trilo.entities.Message"%>
...
<style>
.banner-background {
	clip-path: polygon(35% 0, 70% 0, 100% 0, 99% 98%, 78% 89%, 29% 100%, 1% 79%, 0 0);
}
</style>
</head>
<body>
	...
	<main
		...
		style="height: 75vh; margin-top: 56px;">
		<div class="container">
			<div class="row">
							...
							<form action="LoginServlet" method="POST">
								...
								<div class="form-group">
									...
									<small id="emailHelp" class="form-text text-muted">We'll
										never share your Password with anyone else. Keep it secure..</small>
								</div>
								<br>
